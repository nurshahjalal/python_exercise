...
def open_spinner(message):
    ...
    # through the Logging_Example system, but it acts like it has level INFO,
    # i.e. it's only displayed if we're at level INFO or better.
    # Non-interactive spinner goes through the Logging_Example system, so it is always
    # in sync with Logging_Example configuration.
