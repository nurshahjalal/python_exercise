...
class Command(object):
    ...
    def main(self, args):
        ...
        logger_class = "pip._internal.utils.Logging_Example.ColorizedStreamHandler"
        handler_class = "pip._internal.utils.Logging_Example.BetterRotatingFileHandler"
        ...
        logging.config.dictConfig({
            ...
            "filters": {
                "exclude_warnings": {
                    "()": "pip._internal.utils.Logging_Example.MaxLevelFilter",
            ...
            # Disable any Logging_Example besides WARNING unless we have DEBUG level
            # Logging_Example enabled. These use both pip._vendor and the bare names
